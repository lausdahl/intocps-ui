...
(function ($) {
    ...
    w2sidebar.prototype = {
        ...
        click: function (id, event) {
            ...
            var nd  = this.get(id);
            if (nd == null) return;
            // TODO: Used to be: if (nd.disabled || nd.group) return;
        ...
        contextMenu: function (id, event) {
            ...
            if (edata.isCancelled === true) return;
            // default action
            // TODO: Used to be: if (nd.group || nd.disabled) return;
            ...
            function getNodeHTML(nd) {
                ...
                if (nd.group) {
                    html =
                        ...
                        '        oncontextmenu="w2ui[\''+ obj.name +'\'].contextMenu(\''+ nd.id +'\', event)"'+ //TODO: MANUALLY INSERTED LINE
